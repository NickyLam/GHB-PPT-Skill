...
def _set_val_attr(element: ET.Element, value: Union[str, int] | float) -> None:
...
def _first_workbook_sheet(xlsx_entries: Dict[str, bytes]) -> Optional[str]:
...
def _find_chart_workbook_rel(chart_rels_root: ET.Element) -> Optional[ET.Element]:
