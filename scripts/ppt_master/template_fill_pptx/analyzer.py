...
def _font_size_px(container: ET.Element) -> Optional[float]:
    sizes: List[float] = []
...
def _canvas_px(pres_root: ET.Element) -> Dict[str, Union[int, None]]:
...
def _fill_risk(tables: List[Dict[str, Any]], charts: List[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
