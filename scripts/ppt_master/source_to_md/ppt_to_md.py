...
def normalize_ext(ext: Optional[str], content_type: Optional[str] = None) -> str:
...
def _image_part_for_shape(shape: object) -> Optional[object]:
...
def _image_size_from_bytes(blob: bytes) -> tuple[int | None, Union[int, None]]:
