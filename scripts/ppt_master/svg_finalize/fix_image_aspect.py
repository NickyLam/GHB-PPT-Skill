...
def get_image_dimensions_pil(image_path: str) -> tuple[int , Optional[int]]:
...
def get_image_dimensions_basic(image_path: str) -> tuple[int , Optional[int]]:
...
def get_image_dimensions_from_base64(data_uri: str) -> tuple[int , Optional[int]]:
...
def get_image_dimensions(href: str, svg_dir: str) -> tuple[int , Optional[int]]:
