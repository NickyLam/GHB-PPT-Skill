...
def _slide_config(animation_config: Optional[Dict[str, Any]], svg_stem: str) -> Dict[str, Any]:
...
def create_pptx_with_native_svg(
    ...
    animation_cli_overrides: Optional[Dict[str, bool]] = None,
    narration_audio: Optional[Dict[str, Path]] = None,
    use_narration_timings: bool = False,
    narration_padding: float = 0.5,
    cache_dir: Optional[Path] = None,
    workers: Optional[int] = None,
    merge_paragraphs: bool = True,
    conversion_trace_path: Optional[Path] = None,
    ...
    try:
        ...
        prerender_results: Optional[Dict[int, bool]] = None
        ...
        conversion_trace: List[Dict[str, Any]]  = [] if conversion_trace_path else None
