...
PNG_RENDERER: Optional[str] = None
...
def get_png_renderer_info() -> tuple[str , str, Optional[str]]:
...
def _cache_key(svg_path: Path, width: Optional[int], height: Optional[int]) -> str:
    h = hashlib.sha256()
