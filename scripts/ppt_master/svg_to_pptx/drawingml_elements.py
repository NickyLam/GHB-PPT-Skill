...
def _build_preset_geom_from_meta(elem: ET.Element) -> Optional[str]:
...
def convert_rect(elem: ET.Element, ctx: ConvertContext) -> Optional[ShapeResult]:
...
def convert_circle(elem: ET.Element, ctx: ConvertContext) -> Optional[ShapeResult]:
...
def convert_line(elem: ET.Element, ctx: ConvertContext) -> Optional[ShapeResult]:
...
def convert_path(elem: ET.Element, ctx: ConvertContext) -> Optional[ShapeResult]:
...
def convert_polygon(elem: ET.Element, ctx: ConvertContext) -> Optional[ShapeResult]:
...
def convert_polyline(elem: ET.Element, ctx: ConvertContext) -> Optional[ShapeResult]:
...
def _build_run_xml(
    ...
    ctx: Optional[ConvertContext] = None,
    effect_xml: str = '',
) -> str:
...
def convert_text(elem: ET.Element, ctx: ConvertContext) -> Optional[ShapeResult]:
...
def _read_image_size(data: bytes) -> tuple[int , Optional[int]]:
...
def convert_image(elem: ET.Element, ctx: ConvertContext) -> Optional[ShapeResult]:
...
def convert_ellipse(elem: ET.Element, ctx: ConvertContext) -> Optional[ShapeResult]:
...
def convert_nested_svg(elem: ET.Element, ctx: ConvertContext) -> Optional[ShapeResult]:
