...
from scripts.ghb_visual_quality import evaluate_pilot_gate, measure_svg
...
class VisualMetricsTest(unittest.TestCase):
    ...
    def test_metrics_report_unsupported_geometry_and_malformed_svg(self):
        ...
        self.assertEqual(metrics["occupancy"]["coverage"], "limited")
        self.assertIn("circle", metrics["limitations"])
